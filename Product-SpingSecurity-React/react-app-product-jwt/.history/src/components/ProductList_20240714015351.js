...
function ProductList() {
  ...
  const loadUserDetails = () => {
    // Gọi API hoặc xử lý logic để lấy thông tin chi tiết của người dùng
    // Ví dụ: productService.getUserDetails().then(response => setUserDetails(response.data));
    
    // Giả định thông tin chi tiết của người dùng để demo
    setUserDetails({ role: 'ROLE_ADMIN' }); // Đây là giả định, bạn cần thay đổi để phù hợp với hệ thống của mình
  };
