...
function ProductList() {
  ...
  const checkUserRole = () => {
    // Ví dụ: Gọi API productService.getUserRole() để lấy thông tin vai trò của người dùng
    // productService.getUserRole().then(response => setIsAdmin(response.isAdmin));
    
    // Giả định người dùng là admin để demo
    setIsAdmin(true);
  };
