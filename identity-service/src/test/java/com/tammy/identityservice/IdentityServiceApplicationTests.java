package com.tammy.identityservice;
...
class IdentityServiceApplicationTests {
	...
	void hash() throws NoSuchAlgorithmException {
		...
		//When we passe MD5 algorithm, we 'll get a String 32 characters fixed
		// always when having 1 input , we'll have an Output definite
		md.update(password.getBytes());

		byte[] digest = md.digest();
		//E10ADC3949BA59ABBE56E057F20F883E
		//can not convert to pw initial  "123456"
